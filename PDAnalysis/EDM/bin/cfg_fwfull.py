...
### if selected (see PDAnalyzer) and passed to the following module, if any;
### to filter events according to the processing result replace PDNtuplizer
### with PDFilter (see cfg_filter.py)
...
#    labelJets         = cms.string(''),
    ...
    ## (if missing a default ptCut=15GeV will be used, see PDEDMToNtuple.cc)
