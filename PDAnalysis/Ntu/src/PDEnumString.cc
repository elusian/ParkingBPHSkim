...
std::map<int,std::string> PDEnumString::  vertexRelMapIS;
std::map<std::string,int> PDEnumString::  vertexRelMapSI;
...
//      mP( dummy ) );
  ...
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP3_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP5_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8_IP6_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu8p5_IP3p5_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP4_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP5_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu9_IP6_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu10p5_IP3p5_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu12_IP6_part5_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part0_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part1_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part2_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part3_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part4_v ) );
  trigPathMapSI.insert(
      mP( HLT_Mu7_IP4_part5_v ) );
  ...
  recoObjectMapSI.insert( mP( recSV       ) );
  recoObjectMapSI.insert( mP( recPV       ) );
  ...
  vertexTypeMapSI.insert( mP( refittedTrkSubtract  ) );
  ...
  vertexRelMapSI.insert( mP( vtrFromTracks ) );
  vertexRelMapSI.insert( mP( vtrFromAngle  ) );
  vertexRelMapSI.insert( mP( vtrFromDist   ) );
  vertexRelMapSI.insert( mP( vtrRefit      ) );
  vertexRelMapSI.insert( mP( vtrCascade    ) );
  revertMap( vertexRelMapSI,
             vertexRelMapIS );
...
int
PDEnumString::findVertexRel( const std::string& vtrType ) {
  return find( vtrType, vertexRelMapSI );
}


const std::string&
PDEnumString::findVertexRel( int vtrType ) {
  return find( vtrType, vertexRelMapIS );
}
