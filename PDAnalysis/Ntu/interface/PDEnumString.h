...
//  enum trigPath   { dummy = 0 };
  ...
  enum vertexType { svtTagInfo           =     1,
                    ...
                    svtBdKxMuMu,
                    svtBsJPsiPhi         =   231,
                    refittedTrkSubtract  = 10001,
                    refittedPVAllTrkNoBS = 10011,
                    refittedPVAllTrk,
                    refittedPVRCOnlyNoBS = 10021,
                    refittedPVRCOnly,
                    DUMMY_LAST_VTXTYPE };
  enum vertexRel  { vtrFromTracks =   1,
                    vtrFromAngle,
                    vtrFromDist,
                    vtrRefit      =  11,
                    vtrCascade    = 101 };
  ...
  static int                findVertexRel   ( const std::string& vtrType      );
  static const std::string& findVertexRel   ( int                vtrType      );
 ...
 private:
  ...
  static std::map<int,std::string>    vertexRelMapIS;
  static std::map<std::string,int>    vertexRelMapSI;
