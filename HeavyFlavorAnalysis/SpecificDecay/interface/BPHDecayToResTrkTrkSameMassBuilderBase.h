...
class BPHDecayToResTrkTrkSameMassBuilderBase:
 ...
 public:
  ...
  BPHDecayToResTrkTrkSameMassBuilderBase           ( const BPHDecayToResTrkTrkSameMassBuilderBase& x )
                                          = delete;
  BPHDecayToResTrkTrkSameMassBuilderBase& operator=( const BPHDecayToResTrkTrkSameMassBuilderBase& x )
                                          = delete;
