...
class BPHDecayToResResBuilderBase:
 ...
 public:
  ...
  BPHDecayToResResBuilderBase           ( const BPHDecayToResResBuilderBase& x )
                                      = delete;
  BPHDecayToResResBuilderBase& operator=( const BPHDecayToResResBuilderBase& x )
                                      = delete;
 ...
 protected:
  ...
  class DZSelect: public BPHVertexSelect {
   public:
    ...
    bool accept( const BPHDecayVertex& cand,
                 const BPHRecoBuilder* builder ) const override {
