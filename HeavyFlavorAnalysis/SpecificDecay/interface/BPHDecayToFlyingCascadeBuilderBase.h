...
class BPHDecayToFlyingCascadeBuilderBase:
 ...
 public:
  ...
  BPHDecayToFlyingCascadeBuilderBase           ( const BPHDecayToFlyingCascadeBuilderBase& x )
                                         = delete;
  BPHDecayToFlyingCascadeBuilderBase& operator=( const BPHDecayToFlyingCascadeBuilderBase& x )
                                         = delete;
 ...
 protected:
  ...
  BPHDecayToFlyingCascadeBuilderBase( const std::string& flyName,
                                      double flyMass, double flyMSigma );
